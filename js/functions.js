...
$("#popupCallback").on("click", function(e){
	e.preventDefault();
	$("body").addClass("hidden-y");
	$("#requestCallback").css({display : "flex", visibility : "visible"}).animate({
     	 opacity: 1
    		});
});
$("div.popup-holder span.close").on("click", function(){
